...
for dirname, dirnames, filenames in os.walk('.'):
  ...
  for subdirname in sorted(dirnames):
    ...
    if not ((subdirname == "errors") or (subdirname == "iNZightVIT") or (subdirname == "icons") or (subdirname == "templates") or (subdirname == "data") or (subdirname == "tracker")):
  ...
  for filename in sorted(filenames):
    if not ((filename == "robots.txt") or (filename == "index.html") or (filename == "create_webpages.py") or (filename == "create_webpages.7z") or (filename == "style.css")):
